...
__name$12(FocusGuards, "FocusGuards");
...
__name$12(useFocusGuards, "useFocusGuards");
...
var FocusScope = /* @__PURE__ */ import_react.forwardRef(/* @__PURE__ */ __name$11(function FocusScope2(props, forwardedRef) {
	...
	import_react.useEffect(() => {
		if (trapped) {
			...
			__name$11(handleFocusIn2, "handleFocusIn");
			__name$11(handleFocusOut2, "handleFocusOut");
			__name$11(handleMutations2, "handleMutations");
...
__name$11(focusFirst$2, "focusFirst");
function getTabbableEdges(container) {
	const candidates = getTabbableCandidates(container);
	return [findVisible(candidates, container), findVisible(candidates.reverse(), container)];
}
__name$11(getTabbableEdges, "getTabbableEdges");
function getTabbableCandidates(container) {
	const nodes = [];
	const walker = document.createTreeWalker(container, NodeFilter.SHOW_ELEMENT, { acceptNode: /* @__PURE__ */ __name$11((node) => {
...
__name$11(getTabbableCandidates, "getTabbableCandidates");
...
__name$11(findVisible, "findVisible");
...
__name$11(isHidden, "isHidden");
function isSelectableInput(element) {
	return element instanceof HTMLInputElement && "select" in element;
}
__name$11(isSelectableInput, "isSelectableInput");
...
__name$11(createFocusScopesStack, "createFocusScopesStack");
...
__name$11(arrayRemove, "arrayRemove");
function removeLinks(items) {
	return items.filter((item) => item.tagName !== "A");
}
__name$11(removeLinks, "removeLinks");
//#endregion
...
var Presence = /* @__PURE__ */ __name$6((props) => {
...
function usePresence(present) {
	...
	useLayoutEffect2(() => {
		if (node) {
			...
			const handleAnimationEnd = /* @__PURE__ */ __name$6((event) => {
			...
			const handleAnimationStart = /* @__PURE__ */ __name$6((event) => {
...
__name$6(usePresence, "usePresence");
function setRef(ref, value) {
	if (typeof ref === "function") return ref(value);
	else if (ref !== null && ref !== void 0) ref.current = value;
}
__name$6(setRef, "setRef");
...
__name$6(useStableComposedRefs, "useStableComposedRefs");
function getAnimationName(styles) {
	return styles?.animationName || "none";
}
__name$6(getAnimationName, "getAnimationName");
...
//#endregion
export { FocusScope as C, useId as S, Portal as _, DropdownMenuItemIndicator as a, PopperContent as b, DropdownMenuRadioItem as c, DropdownMenuSubTrigger as d, DropdownMenuTrigger as f, Presence as g, useControllableState as h, DropdownMenuItem as i, DropdownMenuSeparator as l, hideOthers as m, DropdownMenuCheckboxItem as n, DropdownMenuLabel as o, ReactRemoveScroll as p, DropdownMenuContent as r, DropdownMenuPortal as s, DropdownMenu as t, DropdownMenuSubContent as u, Popper as v, useFocusGuards as w, createPopperScope as x, PopperAnchor as y };
