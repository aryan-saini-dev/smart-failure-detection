...
//#region node_modules/.nitro/vite/services/ssr/assets/Aurora-BCwBCWC9.js
...
function Aurora(props) {
	...
	(0, import_react.useEffect)(() => {
		...
		const update = (t) => {
			...
			const { time = t * .01, speed = 1 } = propsRef.current;
			if (program) {
				program.uniforms.uTime.value = time * speed * .1;
